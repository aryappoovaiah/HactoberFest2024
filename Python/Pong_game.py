# github username : aryappoovaiah
# aim: To create a Pong Game using Python.
...
#To set the colour, shape and size of our left paddle.
...
#To set the colour, shape and size of our right paddle.
...
#To set the colour, shape and size of our pong ball.
...
#Code to display the score of player A and player B
